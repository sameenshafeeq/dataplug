<div class="login">
    <div class="loginContent">
        ...
        <input type="text" size="20" class="textBox" id="username" 
        name="username" placeholder="Email"/>
        <input type="password" size="20" class="textBox" id="passowrd" 
        name="password" placeholder="Password"/>
        <p><input type="checkbox"  /> Remember me on this computer</p>
        <p>
            <a style="text-decoration:none;" href="<?= base_url() ?>users/signup/">
            <input type="button"  value="SignUp" class="submit float_right" /></a>
